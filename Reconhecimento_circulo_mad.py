...
__author__      = "Matheus Dib, Fabio de Miranda, Liu"
...
madfox = cv2.imread('madfox.png',0)          # Imagem a procurar
w, h = madfox.shape[::-1]
...
while(True):
    ...
    cv2.imshow('Reconhecimento',bordas_color)
